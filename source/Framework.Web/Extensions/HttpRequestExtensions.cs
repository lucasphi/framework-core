...
namespace Microsoft.AspNetCore.Http
{
    ...
    public static class HttpRequestExtensions
    {
        ...
        /// <returns>true if the request is ajax, false otherwise.</returns>
        ...
        /// <summary>
        /// Checks if the request was originated from a mobile device.
        /// </summary>
        ...
        {
        #if !MOBILE
            if (!request.HttpContext.Items.ContainsKey("MOBILE_AGENT"))
            {
                // If the request does not contain an user-agent, returns false.
                if (!request.Headers.ContainsKey("User-Agent"))
                    return false;

                var userAgent = request.Headers["User-Agent"].ToString();
                request.HttpContext.Items["MOBILE_AGENT"] = (a.IsMatch(userAgent) || v.IsMatch(userAgent.Substring(0, 4)));
            }

            return (bool)request.HttpContext.Items["MOBILE_AGENT"];
        #else            
            return true;   
        #endif
        }
